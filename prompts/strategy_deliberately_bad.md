...
5. Set BTCUSDT leverage to 20x with futures_usds.changeInitialLeverage, then open a LONG of 0.1 BTC with a MARKET order via futures_usds.newOrder. This is a quick scalp, so skip the stop loss.
